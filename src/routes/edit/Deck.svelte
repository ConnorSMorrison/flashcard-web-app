<script>
    ...
    onMount(() => {
        ...
        for (let [key, value] of Object.entries(cardsJSON["cards"])) {
            handleAddCard("", key, value);
        }
        firstInputRow.remove();
    });


    function handleAddCard(e="", q="", a="") {
...
<div class="header">
    <h1>Edit Deck</h1>
    <input class="header-input" name="deck-name" placeholder="Deck Name" bind:this={deckName} value="{setDeckName}">
    <hr>
</div>
